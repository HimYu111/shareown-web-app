...
function Intro() {
  ...
  return (
    <div className="bg-gray-900" style={{ minHeight: 'calc(110vh + 100px)' }}>
      <div className="translate-y-[10rem]">
        <h1 className="text-5xl text-white mb-2" style={{ color: 'lightblue', fontWeight: 'bold', textAlign: 'center' }}>
          Housing Affordability <i>Lifetime Wealth</i> Calculator
        </h1>
        <p className="text-2xl text-white mb-20" style={{ textAlign: 'center' }}>
        ...
        <button
            ...
            className="btn btn-lg text-neutral mb-40"
          >
            Start Now
          </button>
        <h2 className="text-4xl text-white mb-2" style={{ color: 'lightblue', fontWeight: 'bold', textAlign: 'center'}}>
          What it is 
        </h2>
        <p className="text-2xl text-white mb-20" style={{ textAlign: 'center' }}>
        ...
        <p className="text-2xl text-white mb-10" style={{ textAlign: 'center' }}>
        Our  housing affordability lifetime wealth calculator will help calculate your future home ownership path scenarios. 
        It will also show you the wealth you accumulate during the rest of your working life in two scenarios, under full home ownership versus shared ownership.
         </p>
