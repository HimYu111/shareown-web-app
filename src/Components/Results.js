    ...
    return (
      <div className="text-center my-8">
        <h2 className="text-xl font-bold text-white">
          <p>You cannot afford full ownership and shared ownership with the current inputs and the assumptions of the model. However, under different assumptions and inputs you might be able to afford full ownership. 
